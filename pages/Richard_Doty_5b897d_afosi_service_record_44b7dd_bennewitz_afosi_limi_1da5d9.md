...
show_ads: true
description: The Bennewitz file shows contact, concern, and uncertainty, not official confirmation of Bennewitz's extraterrestrial interpretation.
hero_summary: The Bennewitz file shows contact, concern, and uncertainty, not official confirmation of Bennewitz's extraterrestrial interpretation.
layout: default
...
page_heading_title: Did AFOSI Confirm Paul Bennewitz?
source_count: 32
infographic_count: 3
planned_sections:
- The 10 November Kirtland meeting
- AFOSI's stated limits on technical evaluation
...
image: /assets/images/Richard_Doty_5b897d_afosi_service_record_44b7dd_bennewitz_afosi_limi_1da5d9-Illustration-1-social.jpg
---
...
The best-known early episode occurred on 10 November 1980, after Bennewitz had contacted Kirtland Air Force Base with claims that he was intercepting unusual signals and observing unexplained aerial activity near restricted military facilities. Historical accounts agree that he was invited to present his findings to personnel connected with Kirtland. The meeting has become central to the Doty story because it placed Bennewitz’s allegations inside an official military setting. <span class="citation-link-wrap"><a class="citation-inline-link" href="https://en.wikipedia.org/wiki/UFO_reports_and_disinformation" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: Wikipedia">[Wikipedia]</a><span class="citation-popover" role="note"><span class="citation-popover-source">Wikipedia</span><span class="citation-popover-title">UFO reports and disinformation</span><span class="citation-popover-snippet">UFO reports and disinformation</span></span></span>
...
A frequently overlooked feature of the Bennewitz episode is the institutional role of AFOSI itself. AFOSI is a counterintelligence and investigative organisation, not a scientific body tasked with determining whether unusual radio signals originate from extraterrestrial sources.

The available record indicates that AFOSI became interested because Bennewitz was observing activity near highly sensitive installations around Kirtland, Manzano, and Sandia. That concern falls squarely within a counterintelligence mission. Determining whether intercepted signals represented alien communications would have required technical and scientific expertise beyond AFOSI's normal remit. <span class="citation-link-wrap"><a class="citation-inline-link" href="https://en.wikipedia.org/wiki/UFO_reports_and_disinformation" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: Wikipedia">[Wikipedia]</a><span class="citation-popover" role="note"><span class="citation-popover-source">Wikipedia</span><span class="citation-popover-title">UFO reports and disinformation</span><span class="citation-popover-snippet">UFO reports and disinformation</span></span></span>

This limitation is significant when evaluating later claims. Some accounts imply that AFOSI contact itself amounted to a technical validation of Bennewitz's theories. The logic does not follow. An intelligence service can investigate whether a civilian has stumbled onto sensitive information without agreeing with the civilian's explanation for what was observed.
...
* Military officials were concerned about activities near restricted facilities.
* AFOSI had reason to assess potential security implications.
...
For the broader question of Richard Doty's credibility, the Bennewitz record provides both support and caution.
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to Did AFOSI Confirm Paul Bennewitz?. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
