...
show_ads: true
description: A recovery claim becomes far more testable when dates, handlers, transfer logs, storage sites and lab records can be checked against each other.
hero_summary: A recovery claim becomes far more testable when dates, handlers, transfer logs, storage sites and lab records can be checked against each other.
layout: default
...
page_heading_title: Where Would The Paper Trail Be?
source_count: 52
infographic_count: 3
planned_sections:
- What a credible recovery chain would normally record
- Which links are absent from Grusch's public account
- How records could confirm or weaken the allegation
...
image: /assets/images/David_Grusch_f99f18_second_hand_testimon_091aaa_missing_custody_reco_9840b2-Illustration-1-social.jpg
---
...
If a government recovered an unknown aerospace vehicle, investigators would expect more than witness testimony. A credible chain of custody normally creates multiple layers of documentation because different organisations become responsible for different stages of handling.

Even highly classified programmes generally generate records such as:

* Recovery authorisations and incident reports.
* Transportation orders and logistics records.
* Storage inventories and facility access logs.
* Laboratory intake forms and testing requests.
* Contracting documents for technical analysis.
* Security classification and compartment records.
* Budget authorisations and programme [oversight]({{ 'oversight/' | relative_url }}) documentation.
* Personnel access lists and clearance approvals.

The exact content could remain classified, but the existence of administrative records is difficult to avoid. Modern defence and intelligence systems rely on accountability mechanisms because equipment, facilities, funding and personnel all require management.

This is why chain-of-custody questions matter so much in the Grusch case. The alleged programmes are not described as brief investigations involving a single recovered item. They are described as multi-decade efforts involving repeated recoveries, exploitation work and participation by government agencies and defence contractors. If such activities occurred over decades, the quantity of associated records would likely be substantial. <span class="citation-chip-wrap"><a class="citation-chip" href="https://thedebrief.org/intelligence-officials-say-u-s-has-retrieved-non-human-craft/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: thedebrief.org">[The Debrief]</a><span class="citation-popover" role="note"><span class="citation-popover-source">thedebrief.org</span><span class="citation-popover-title">The Debrief Intelligence Officials Say U.S</span><span class="citation-popover-snippet">Has Retrieved Craft of Non-...Jun 5, 2023 — According to the unclassified complaint, in July 2021, Grusch had confidentially provided cl...</span><span class="citation-popover-meta">Published: July 2021</span></span></span>
...
1. The location of a specific recovery.
2. The organisation that secured the material.
3. The unit that transported it.
4. The facility that received it.
5. The laboratory that analysed it.
6. The office responsible for long-term custody.

</div>

Without that sequence, outsiders cannot reconstruct the movement of an alleged craft through government systems.

### Verifiable inventory records

No publicly released inventory sheets, accession records, property-control documents or material-tracking records have been produced to demonstrate that a recovered non-human craft entered government possession.

This is significant because inventory systems exist precisely to establish accountability for physical assets, including highly sensitive ones.

### Laboratory documentation

Grusch's public claims imply that technical examination occurred somewhere. Yet no authenticated testing reports, metallurgical analyses, engineering studies or laboratory custody records tied to a recovered craft have been released publicly.
...
Popular discussion often focuses on whether there are photographs of alien craft. From an evidential perspective, custody records may be more important.
...
## The Oversight Problem Versus the Public-Evidence Problem

Supporters of Grusch often make an important distinction. They argue that Congress, inspectors general and authorised investigators may have access to information that cannot be released publicly.
...
* Did Grusch provide specific classified leads to authorised investigators?
* Has the public seen evidence sufficient to verify the recovery allegations independently?

</div>

The answer to the first question may not be fully known because classified briefings are not public. The answer to the second is clearer: the public has not been shown a complete custody trail for any alleged recovered non-human craft. <span class="citation-chip-wrap"><a class="citation-chip" href="https://thedebrief.org/intelligence-officials-say-u-s-has-retrieved-non-human-craft/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: thedebrief.org">[The Debrief]</a><span class="citation-popover" role="note"><span class="citation-popover-source">