...
show_ads: true
description: Taylor's own criticism of unreleased Bigelow-era data creates a fair benchmark for judging the later television-era claims too.
hero_summary: Taylor's own criticism of unreleased Bigelow-era data creates a fair benchmark for judging the later television-era claims too.
layout: default
...
page_heading_title: Taylor's own test for hidden data
source_count: 44
infographic_count: 3
planned_sections:
- Why unreleased Bigelow records matter
- Taylor's repeatability standard
...
image: /assets/images/Travis_Taylor_c76455_skinwalker_ranch_evi_a68272_bigelow_secrecy_stan_e49083-Illustration-1-social.jpg
---
...
## Why unreleased Bigelow records still matter

[Skinwalker]({{ 'skinwalker-4c0f0b/' | relative_url }}) Ranch's modern reputation was largely built during Robert Bigelow's ownership. Through the National Institute for Discovery Science (NIDS), and later related organisations, investigators spent years collecting witness reports, conducting surveillance and pursuing [claims]({{ 'claims/' | relative_url }}) involving UFOs, animal mutilations, strange lights and other alleged phenomena. Yet only a limited portion of that material entered the public domain. <span class="citation-link-wrap"><a class="citation-inline-link" href="https://en.wikipedia.org/wiki/The_Secret_of_Skinwalker_Ranch" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: Wikipedia">[Wikipedia]</a><span class="citation-popover" role="note"><span class="citation-popover-source">Wikipedia</span><span class="citation-popover-title">The Secret of Skinwalker Ranch</span><span class="citation-popover-snippet">The Secret of Skinwalker Ranch</span></span></span>
...
Taylor addressed this issue directly in an interview about Skinwalker Ranch. Asked whether he drew lessons from Bigelow's earlier investigation, he responded that because Bigelow never released his information, "it might as well never have happened" from a scientific perspective. He immediately connected that criticism to a core principle: other researchers must be able to repeat experiments and examine results for themselves. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.history.co.uk/shows/curse-of-skinwalker-ranch/brandon-fugal-and-dr-travis-taylor-curse-of-skinwalker-ranch-interview" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: history.co.uk">[Sky HISTORY TV channel]</a><span class="citation-popover" role="note"><span class="citation-popover-source">history.co.uk</span><span class="citation-popover-snippet">Sky HISTORY TV channel&#x27;High strangeness&#x27;: Brandon Fugal and Dr Travis Taylor...&#x27;High strangeness&#x27;: Brandon Fugal and Dr Travis Taylor di...</span></span></span>

That statement is important because it shows Taylor framing the debate in methodological terms rather than paranormal ones. He was not arguing that Bigelow's team found nothing. Instead, he was arguing that unreleased findings cannot function as robust scientific evidence.

In conventional science, repeatability does not guarantee a result is correct, but it allows others to challenge, refine or confirm it. A claimed anomaly that appears only inside a closed research programme remains difficult to separate from error, misinterpretation, equipment malfunction or selective reporting. Taylor's criticism implicitly acknowledges that problem. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.history.co.uk/shows/curse-of-skinwalker-ranch/brandon-fugal-and-dr-travis-taylor-curse-of-skinwalker-ranch-interview" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: history.co.uk">[Sky HISTORY TV channel]</a><span class="citation-popover" role="note"><span class="citation-popover-source">history.co.uk</span><span class="citation-popover-snippet">Sky HISTORY TV channel&#x27;High strangeness&#x27;: Brandon Fugal and Dr Travis Taylor...&#x27;High strangeness&#x27;: Brandon Fugal and Dr Travis Taylor di...</span></span></span>

This also fits with how Taylor has described his own approach to UFO and paranormal claims. He has often portrayed himself as someone initially sceptical of witness testimony alone, preferring instrument-based observations and measurable effects. His public narrative is that Skinwalker Ranch became persuasive because he believed he encountered events accompanied by technical measurements rather than stories alone. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.history.co.uk/shows/curse-of-skinwalker-ranch/brandon-fugal-and-dr-travis-taylor-curse-of-skinwalker-ranch-interview" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: history.co.uk">[Sky HISTORY TV channel]</a><span class="citation-popover" role="note"><span class="citation-popover-source">history.co.uk</span><span class="citation-popover-snippet">Sky HISTORY TV channel&#x27;High strangeness&#x27;: Brandon Fugal and Dr Travis Taylor...&#x27;High strangeness&#x27;: Brandon Fugal and Dr Travis Taylor di...</span></span></span>
...
Once Taylor establishes repeatability as the test, the question naturally turns towards *The Secret of Skinwalker Ranch* itself.

The programme presents numerous measurements, experiments and anomalies. Viewers see electromagnetic readings, GPS disruptions, [radiation]({{ 'radiation/' | relative_url }}) concerns, rocket launches, drone operations and other technical investigations. Some of these experiments involve real instruments and personnel with scientific or engineering backgrounds. The issue is whether enough information is publicly available for independent assessment. <span class="citation-link-wrap"><a class="citation-inline-link" href="https://en.wikipedia.org/wiki/National_Institute_for_Discovery_Science" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: Wikipedia">[Wikipedia]</a><span class="citation-popover" role="note"><span class="citation-popover-source">Wikipedia</span><span class="citation-popover-title">National Institute for Discovery Science</span><span class="citation-popover-snippet">National Institute for Discovery Science</span></span></span>
...
Supporters see him as one of the few public UFO-linked figures willing to discuss methodology at all. They note that he openly acknowledges the need for measurement, instrumentation and repeatability instead of relying entirely on anecdotes. His criticism of Bigelow-era secrecy can be interpreted as evidence that he understands the weaknesses of closed investigations. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.history.co.uk/shows/curse-of-skinwalker-ranch/brandon-fugal-and-dr-travis-taylor-curse-of-skinwalker-ranch-interview" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: history.co.uk">[Sky HISTORY TV channel]</a><span class="citation-popover" role="note"><span class="citation-popover-source">history.co.uk</span><span class="citation-popover-snippet">Sky HISTORY TV channel&#x27;High strangeness&#x27;: Brandon Fugal and Dr Travis Taylor...&#x27;High strangeness&#x27;: Brandon Fugal and Dr Travis Taylor di...</span></span></span>

Critics reach a different conclusion. They argue that Taylor identified a genuine scientific problem but has not fully solved it in the television era. From that perspective, the programme still asks viewers to accept conclusions that cannot yet be independently reproduced using publicly available records. The criticism is not necessarily that the anomalies are fake. It is that the evidential structure remains incomplete. <span class="citation-link-wrap"><a class="citation-inline-link" href="https://en.wikipedia.org/wiki/The_Secret_of_Skinwalker_Ranch" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: Wikipedia">[Wikipedia]</a><span class="citation-popover" role="note"><span class="citation-popover-source">Wikipedia</span><span class="citation-popover-title">The Secret of Skinwalker Ranch</span><span class="citation-popover-snippet">The Secret of Skinwalker Ranch</span></span></span>
...
If the Bigelow years are criticised because the underlying records remain inaccessible, then the same question should be asked of later investigations. Are the datasets available? Can independent researchers inspect them? Can the experiments be repeated under comparable conditions? Can alternative explanations be ruled out using the published record?
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to Taylor&#x27;s own test for hidden data. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Directly covers the Bigelow-era investigations and the question of unpublished evidence.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Emphasizes documented cases, records and evidential standards.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explores scientific evaluation and repeatability issues in anomaly research.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Focuses on government-linked investigations and debates over evidence access.</p>
        <div class="fr-book-actions">
