...
That sequence is easy to overread. It shows that the proposal reached a serious bureaucratic stage; it does not show that DHS possessed the materials in question. AARO’s one-page KONA BLUE history states directly that no data or material of any kind was transferred to or collected by DHS under KONA BLUE, and that information from AAWSAP/AATIP remained in DIA archived holdings.<span class="citation-link-wrap"><a class="citation-inline-link" href="https://www.aaro.mil/Portals/136/PDFs/AARO_Historical_Record_Report_Vol_1_2024.pdf" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: aaro.mil">[aaro.mil]</a><span class="citation-popover" role="note"><span class="citation-popover-source">aaro.mil</span><span class="citation-popover-title">AARO Historical Record Report Vol</span><span class="citation-popover-snippet">AARO Historical Record Report Vol</span></span></span>
